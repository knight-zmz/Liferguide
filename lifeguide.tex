...
% region 模块J：内容块标题
\newcommand{\blocktitle}[1]{\par\smallskip\textbf{#1}\par}
% endregion 模块J：内容块标题
...
\blocktitle{准备 ${\rightarrow}$ 推荐 ${\rightarrow}$ 录取}
\begin{itemize}
...
本阶段的唯一目标是：\par
\blocktitle{在学院综合排名中进入推免范围,获得推免资格。}
...
\end{itemize}
\blocktitle{注}
可以选择的方向很多,学长学姐仅仅是提供一个启示。

\subsubsection{本校录取选择情况}

\blocktitle{2025 届毕业保研生选择本校情况}
...
\end{tabularx}
\end{table}
\blocktitle{2026 届直博生拨付名额与实际接受名额}
...
\blocktitle{重要提醒}
不算加分的纯成绩排名是最重要的。这能为你争取到参加夏令营资格。等到了大三下后,有些同学会取得很多成果,使得纯成绩再加上素质加分项后,排名会波动,多数会有约0.1-0.3范围的浮动,保研边缘同学需要注意。
\subsubsection{流程总概括}
...
项目管理的核心目标只有一个：
\blocktitle{在多院校、多材料、多截止日期的情况下,避免混乱与低级错误。}
...
\end{itemize}
\blocktitle{在焦虑存在的情况下继续推进事务,本身就是一种能力。}
...
\end{itemize}
\blocktitle{原则}
只暴露你\textbf{能够承接追问}的内容,避免``挖坑后无法填坑''。
...
\blocktitle{反例提醒}
给纯生信方向的导师,长时间讲述蛋白表达纯化的操作细节,往往是减分项。
...
\subsubsection{研究论文：先``自己设计'',再``看别人怎么做''}
...
\subsubsection{从``能读''到``能讲''：能力跃迁的关键一步}
...
\begin{itemize}
\item \textbf{硬门槛}：上海一些中科院系统与 C9 高校常见六级门槛；六级未过可能连网申都无法提交(建议尽早补齐语言短板)
\item \textbf{补充路径}：如果六级在保研前没有通过,考虑通过雅思托福获得额外的机会(这是常见路径)。
\end{itemize}
\subsection{\label{ref-035}资料搜集}

\subsubsection{资料搜集是贯穿整个本科阶段的基础能力}
...
\subsubsection{资料来源有明确的优先级,需要分清``结论''和``线索''}
...
\begin{enumerate}
\item \textbf{\textcolor{title-section}{中科院生物物理研究所(IBP,北京)}}
...
\end{itemize}
\item \textbf{\textcolor{title-section}{分子细胞科学卓越创新中心(上海生化所/生化与细胞所,SIBCB)}}
...
\item \textbf{\textcolor{title-section}{中国科学院遗传与发育生物学研究所}}
...
\item 分子发育生物学国家重点实验室
\end{itemize}
\item \textbf{\textcolor{title-section}{中科院深圳先进技术研究院｜合成生物学研究所}}
...
\end{itemize}
\item \textbf{\textcolor{title-section}{生物与化学交叉研究中心(交叉中心)}}
...
\end{itemize}
\item \textbf{\textcolor{title-section}{中科院微生物研究所(北京)}}
...
\item \textbf{\textcolor{title-section}{中科院青岛生物能源与过程研究所}}
...
\item \textbf{\textcolor{title-section}{天津工业生物技术研究所}}

\blocktitle{简介}

中国科学院天津工业生物技术研究所是由中国科学院和天津市人民政府共建、从事生物技术创新推动工业领域生态发展的科研机构。其定位是：以生物设计为核心,开展工业生物技术战略性、前瞻性的基础与应用基础研究,集聚工业生物科技力量,创新生物产业关键核心技术与重大颠覆性技术,构建工业经济发展的生态路线,服务我国绿色生物经济与社会经济可持续的发展。
...
\begin{enumerate}
\item \textbf{\textcolor{title-section}{吉林大学(直博经验)}}
...
\item \textbf{\textcolor{title-section}{浙江大学｜生命科学研究院(生研院)}}
...
\end{itemize}
\item \textbf{\textcolor{title-section}{浙江大学｜转化医学研究院}}
...
\end{itemize}
\item \textbf{\textcolor{title-section}{复旦大学｜基础医学院(枫林校区)}}
...
\end{itemize}
\item \textbf{\textcolor{title-section}{复旦大学脑科学转化研究院}}
...
\end{itemize}
\item \textbf{\textcolor{title-section}{上海交通大学｜生命科学技术学院(闵行)}}
...
\end{itemize}
\item \textbf{\textcolor{title-section}{上海交通大学｜上海市免疫研究所}}
...
\end{itemize}
\item \textbf{\textcolor{title-section}{香港科技大学}}
...
\end{itemize}
\item \textbf{\textcolor{title-section}{西湖大学}}
...
\item 不鼓励 PI 拉横向项目
\end{itemize}
\item \textbf{\textcolor{title-section}{北京协和}}
